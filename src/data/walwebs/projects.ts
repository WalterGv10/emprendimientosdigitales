...
export const projectsData: ProjectItem[] = [
    {
        ...
        link: "/perfil/proyecto/control-fac",
        icon: React.createElement(ScanText, { size: 40 }),
        color: "from-orange-500 to-red-600",
        image: "/walwebs/controlfac-preview.webp"
    },
    {
        id: "ram-pump",
        ...
        link: "/perfil/proyecto/bomba-ariete",
        icon: React.createElement(Droplets, { size: 40 }),
        color: "from-blue-400 to-cyan-500",
        image: "/walwebs/ram-pump-preview.webp"
    },
    {
        ...
        link: "/perfil/proyecto/catalogo-camisolas",
        icon: React.createElement(Shirt, { size: 40 }),
        color: "from-indigo-500 to-blue-600",
        image: "/walwebs/camisolas-preview.webp"
    },
    {
        id: "dj-magnuz",
        title: "DJ Magnuz",
        ...
        link: "/perfil/proyecto/dj-magnuz",
        icon: React.createElement(Radio, { size: 40 }),
        color: "from-purple-500 to-pink-500",
        image: "/walwebs/dj-magnuz-preview.webp"
    },
    {
        id: "music-visuals",
        title: "Music Visuals",
    ...
    },
    {
        ...
        link: "/perfil/proyecto/cv-damaris",
        icon: React.createElement(Briefcase, { size: 40 }),
        color: "from-blue-500 to-purple-600",
        image: "/walwebs/damaris-cv-preview.webp"
    }
];
