...
export function Header() {
    ...
    const navLinks = [
        { name: "Inicio", href: "/perfil" },
        { name: "Servicios", href: "/perfil/servicios" },
        { name: "Trayectoria", href: "/perfil/trayectoria" },
        { name: "Trabajo", href: "/perfil/trabajo" },
        { name: "Mundial 2026", href: "/perfil/mundial" },
        { name: "Arquitectura", href: "/perfil/arquitectura" },
        { name: "Contacto", href: "/perfil/contacto" },
    ];
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50 px-4 py-4 pointer-events-none">
            ...
            >
                ...
                >
                    {/* Logo & Brand */}
                    <Link href="/perfil" onClick={(e) => handleNavClick(e, "/perfil")} className="flex items-center gap-2 md:gap-3 group relative z-50">
                        ...
                        <div className="flex flex-col">
                            <span className="text-base md:text-xl font-black tracking-tighter text-white leading-none">
                                WAL<span className="text-blue-500 group-hover:text-cyan-400 transition-colors">WEBS</span>
                            </span>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <Link
                            ...
                            onClick={(e) => handleNavClick(e, "/perfil/contacto")}
