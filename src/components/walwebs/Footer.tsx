...
const socialLinks = [
    ...
    {
        name: "Instagram",
        href: "https://www.instagram.com/walwebestudio/",
        icon: (
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full overflow-hidden pointer-events-none whitespace-nowrap opacity-[0.07] select-none">
                ...
                >
                    WALWEBS DIGITAL TRANSFORMATION • INNOVACIÓN REAL •
                </motion.h2>
            </div>
                ...
                <div className="flex flex-col gap-24">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 pt-16 border-t-4 border-zinc-900">
                        <div className="flex items-center gap-8">
                            <Link href="/perfil" className="relative w-20 h-20 hover:scale-105 transition-transform cursor-pointer">
                                <Image
                                    src="/walwebs/logo.webp"
                                    alt="WalWebs"
                                    fill
                            ...
                            <div className="flex flex-col">
                                <span className="text-3xl font-black tracking-tighter text-white">WALWEBS</span>
                        ...
                        <div className="flex flex-wrap justify-center gap-12">
                            <Link href="/" className="text-xs font-black uppercase tracking-widest text-zinc-500 hover:text-blue-400 transition-colors flex items-center gap-2">
                                <ArrowRight className="w-3 h-3 rotate-180" />
                                Volver a EmprendeDigital
                            </Link>
                            <div className="w-px h-3 bg-zinc-800 hidden sm:block" />
                            <Link href="/perfil" className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Inicio</Link>
                            <Link href="/perfil/servicios" className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Servicios</Link>
                            <Link href="/perfil/trabajo" className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Portafolio</Link>
                            <Link href="/perfil/trayectoria" className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">Trayectoria</Link>
                        </div>
