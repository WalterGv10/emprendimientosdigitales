...
import { Mail, MessageSquare, Linkedin, Youtube, Music2, Instagram } from "lucide-react";
...
export function Contact() {
    const satellites = [
        ...
        },
        {
            ...
            position: "md:top-[10%] md:right-[-10px]"
        },
        {
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="flex flex-col items-center justify-center order-2 lg:order-2 relative">
                        ...
                        {satellites.map((sat, i) => (
                            <motion.a
                                ...
                                className={`
                                    ...
                                    ${i === 2 ? "hover:shadow-[0_0_25px_rgba(219,39,119,0.6)] hover:border-pink-500/50" : ""}
                                    ${i === 3 ? "hover:shadow-[0_0_25px_rgba(10,102,194,0.6)] hover:border-blue-400/50" : ""}
                                `}
                                title={sat.label}
                            >
                    ...
                    <div className="flex lg:hidden flex-col items-center gap-8 w-full max-w-[320px]">
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-8 w-fit place-items-center">
                            {satellites.map((sat, i) => (
                                <motion.a
                                    key={i}
                                    href={sat.href}
                                ...
                                >
                                    <div className={`
                                        ...
                                        ${i === 2 ? "shadow-pink-900/20 border-pink-500/30 text-pink-400" : ""}
                                        ${i === 3 ? "shadow-blue-900/20 border-sky-600/30 text-[#0077b5]" : ""}
                                    `}>
                                        {sat.icon}
                                    </div>
