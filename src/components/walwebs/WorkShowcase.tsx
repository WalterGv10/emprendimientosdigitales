...
import { projectsData } from "@/data/walwebs/projects";

export function WorkShowcase() {
    return (
        <section className="py-24 px-4 relative z-10 overflow-hidden">
            {/* Background Texture */}
            <div className="absolute inset-0 bg-[url('/walwebs/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" />
