    ...
    return (
        <div className="relative w-full min-h-screen bg-white overflow-hidden pt-16 md:pt-20">
            ...
            <div className="relative z-10">
                ...
                <PageNavigation nextPath="/perfil/trabajo" nextLabel="Ver Más Proyectos" />
            </div>
        </div>
    );
}
